...
public class FetchRecipes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String RecipeManagementService=System.getenv("RecipeManagementService");
        System.out.println(RecipeManagementService);
        ...
        WebTarget webTarget = client.target("http://"+RecipeManagementService+"/RecipeManagement/webresources/Recipe")
